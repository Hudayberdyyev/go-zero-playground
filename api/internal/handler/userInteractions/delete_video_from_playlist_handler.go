...
func DeleteVideoFromPlaylistHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := userInteractions.NewDeleteVideoFromPlaylistLogic(r.Context(), svcCtx)
		resp, err := l.DeleteVideoFromPlaylist(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
