...
func VideoSetWatchTimeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.VideoSetWatchTimeReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := userInteractions.NewVideoSetWatchTimeLogic(r.Context(), svcCtx)
		resp, err := l.VideoSetWatchTime(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
