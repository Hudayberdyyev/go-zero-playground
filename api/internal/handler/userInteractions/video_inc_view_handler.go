...
func VideoIncViewHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.VideoIncViewReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := userInteractions.NewVideoIncViewLogic(r.Context(), svcCtx)
		resp, err := l.VideoIncView(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
