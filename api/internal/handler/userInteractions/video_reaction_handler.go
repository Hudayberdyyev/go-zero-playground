...
func VideoReactionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.VideoReactionReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := userInteractions.NewVideoReactionLogic(r.Context(), svcCtx)
		resp, err := l.VideoReaction(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
